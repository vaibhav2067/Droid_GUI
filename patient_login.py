...
from virtual_keyboard import VirtualKeyboard  # <- IMPORT here
...
class FullscreenWindow(QMainWindow):
    def __init__(self):
        ...
        self.keyboard = VirtualKeyboard()  # <- No argument needed!
    ...
    def eventFilter(self, source, event):
        if event.type() == QEvent.FocusIn and isinstance(source, QLineEdit):
            ...
            self.keyboard.show()
        # elif event.type() == QEvent.FocusOut and isinstance(source, QLineEdit):
        #     # Optional: Hide keyboard when focus leaves
        #     self.keyboard.hide()
