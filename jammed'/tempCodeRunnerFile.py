...
class RobotDashboard(QMainWindow):
    ...
    def initUI(self):
        ...
        self.canvas.setStyleSheet("background-color: rgba(255, 255, 255, 180); border-radius: 15px;")
    ...
    def create_assign_medicine_screen(self, patient_id):
        ...
        # Custom Header Labels for Medicine Times
        ...
        # Medicine Table without internal headers
